export const httpStatusCodes = [
    ...
    // ** Unofficial/Cloudflare Codes ** \\
    { value: "419", label: "419 - Page Expired" },
    { value: "420", label: "420 - Method Failure" },
    { value: "430", label: "430 - Request Header Too Large" },
    ...
    { value: "529", label: "529 - Site is overloaded" },
    { value: "530", label: "530 - Site is frozen" },
...
/** 
 ...
 @returns {string}
*/
export const getHttpStatusCodeLabel = (code: string): string => {
    const foundStatusCode = httpStatusCodes.find((codeData) => codeData.value === code);
    if (!foundStatusCode) return "";


    return foundStatusCode.label.split("-").slice(1).join("");
}